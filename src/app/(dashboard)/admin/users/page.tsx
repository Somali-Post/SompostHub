...
import { Search, Filter, Plus, MoreHorizontal, Lock, User, X, Check, Edit } from 'lucide-react';
...
export default function StaffManagementPage() {
  ...
  const handleCreateUser = async () => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success('User Created (PIN: 0000)');
  ...
  return (
    <div className="flex flex-col gap-6 h-[calc(100vh-4rem)] p-6 md:p-8">
                  ...
                  <tr key={user.id} className="hover:bg-slate-50 transition-colors group">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-slate-100 flex items-center justify-center font-bold text-slate-600 overflow-hidden relative">
                          {user.avatar ? (
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex justify-end gap-2">
                        <button
                          ...
                          className="p-2 text-slate-400 hover:text-auth-button hover:bg-slate-100 rounded transition-colors"
                          title="Edit Profile"
                        >
                          <Edit size={16} />
                        </button>
          ...
          <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-slate-200 rounded-lg px-4 py-2 text-sm bg-white"
                  >
            ...
            <div className="p-6 border-t border-slate-100 bg-slate-50 flex gap-3">
              <button
                ...
                disabled={isLoading}
                className="flex-1 bg-auth-button text-white py-3 rounded-lg font-bold text-sm hover:bg-auth-buttonHover shadow-sm"
              >
