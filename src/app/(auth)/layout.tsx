...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row font-sans text-slate-900 bg-slate-50 lg:bg-none">
      <div className="hidden lg:flex relative w-[45%] p-12 flex-col justify-between text-white overflow-hidden bg-gradient-to-br from-auth-sidebarFrom to-auth-sidebarTo">
        ...
        <div className="relative z-10 flex flex-col h-full justify-center pl-2">
          <div className="flex flex-col items-start mb-10">
            ...
            <h2 className="text-lg font-medium opacity-80 uppercase tracking-[0.25em]">Employee Hub</h2>
          </div>
          ...
          <div className="space-y-5 text-lg leading-relaxed text-white/90 max-w-lg">
            <p className="font-semibold text-xl text-white">Welcome to your new digital partner.</p>
            <p className="text-base opacity-80 font-light leading-7">
              This Hub replaces paperwork with instant scanning, speeds up delivery with simple photo proof, and keeps
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-0 lg:p-6 bg-transparent lg:bg-auth-bg w-full">
        {children}
      </div>
    </div>
  );
